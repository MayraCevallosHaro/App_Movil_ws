package com.example.app_movil_ws.WSSoap;
...
import com.example.app_movil_ws.WebServices.Asynchtask;
...
public class SOAPWork extends AsyncTask<String,Long,String> {
    ...
    private String url= "http://192.168.100.5:8080/Server_App_Movil/";
